# Taiwan Trip Tracker · madebycal

Where in the world is Cal? A static site that shows where I am on any day of the Taiwan trip, in the madebycal design language. It's a copy of the Europe trip tracker; trip settings (including the Taiwan map view) live in `src/data/trip.js`.
