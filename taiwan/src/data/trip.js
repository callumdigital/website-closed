...
export default {
  title: 'Taiwan 2026',
  travellers: 'Cal', // one name → "Where in the world is Cal?"; "A & B" → "…are A & B?"
  ...
  photos: { supabaseUrl: '', supabaseKey: '', trip: 'taiwan' }, // trip: this tracker's photos, if the Supabase project is shared
